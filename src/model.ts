...
export interface BaseObject extends Transform {
 id:ObjectId; type:BioPlotObjectType; name:string; groupId?:string; parentId?:string; locked?:boolean; hidden?:boolean;
}
...
export function migrateDocument(input:unknown):BioPlotDocument {
 ...
 if(candidate.schemaVersion===DOCUMENT_SCHEMA_VERSION) return candidate as BioPlotDocument;
