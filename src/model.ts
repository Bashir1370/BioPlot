...
export interface ArrowObject extends BaseObject { type:'arrow'; stroke:string; strokeWidth:number; lineStyle?:LineStyle; arrowHead:'end'|'both'|'none'; startPoint?:{x:number;y:number}; endPoint?:{x:number;y:number}; startHead?:LineCap; endHead?:LineCap; }
