...
export function EditorStudio(){
  ...
  function addObject(object:BioPlotObject){setSelectionToolbarVisible(true);storeRef.current.dispatch(new AddObjectsCommand('Add object',[object]));setSelected(new Set([object.id]));setAssetEditOpen(object.type==='asset');if(object.type==='asset')setLibraryCollapsed(false);setInspectorTab('properties');if(object.type==='arrow')setInspectorCollapsed(false);}
